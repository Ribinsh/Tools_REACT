        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mb-12">
            <article>
                ...
                <section class="mt-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-8">
                    <article class="relative w-full h-64 bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1511376777868-611b54f68947?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80')] group rounded-lg overflow-hidden shadow-lg hover:shadow-2xl  transition duration-300 ease-in-out"
                    ...
                    <article class="relative w-full h-64 bg-cover bg-[url('https://images.m.media-amazon.com/images/I/716oqUb4auL._SL1500_.jpg"
                    ...
                    <article class="relative w-full h-64 bg-cover bg-[url('https://images.unsplash.com/photo-1511376777868-611b54f68947?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80')] bg-center group rounded-lg overflow-hidden shadow-lg hover:shadow-2xl  transition duration-300 ease-in-out"
