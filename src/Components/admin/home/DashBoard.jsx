...
function dashBoard(props) {
  ...
  return (
    <div className="">
      <body class="font-poppins antialiased sticky top-0">
        <div id="view" class="h-full  flex  " x-data="{ sidenav: true }">
          ...
          >
            <div class="space-y-6 md:space-y-10 mt-5">
              <div id="profile" class="space-y-3">
                ...
                />
                <div>
                  <h2 class="font-medium text-xl md:text-2xl text-center text-teal-500">
                    Toools
                  </h2>
                  <p class="text-lg text-gray-500 text-center">Administrator</p>
                </div>
              </div>
              ...
              <div id="menu" class="flex flex-col space-y-2">
                ...
                >
                  ...
                  <span class="cursor-pointer">Customers</span>
                </a>
                <a
                  onClick={() => {
                ...
                >
                  ...
                  <span class="cursor-pointer">Add Product</span>
                </a>
                <a
                  onClick={() => {
