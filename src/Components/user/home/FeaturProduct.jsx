                    ...
                    <div class="flex-auto justify-evenly">
                      <div class="flex flex-wrap ">
                        <div class="w-full flex-none text-sm flex items-center text-gray-600">
                          ...
                          <span class="text-gray-800 whitespace-nowrap mr-3 font-semibold">
                            4.60
                          </span>
                        </div>
                      ...
                      <div class="text-xl text-black font-bold mt-1">
                        {product.rentPrice}/day
                      </div>
                      <Link
                        to={"/Booking"}
                        state={product._id}
                        class="flex space-x-2 text-sm font-medium justify-start mt-3"
                      >
