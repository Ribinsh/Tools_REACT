...
function FeaturProduct() {

    const navigate = useNavigate()
    const productName = "Driller"
              ...
              <div class="flex flex-col ">
                <div class="">
                  <div class="relative h-62 w-full mb-3">
                    ...
                    <img src="https://5.imimg.com/data5/HP/PV/MY-18623913/hitachi-professional-hand-drilling-machine-500x500.jpg" alt="Just a flower" class=" w-full   object-fill  rounded-2xl" />
                  </div>
                  <div class="flex-auto justify-evenly">
                    ...
                    <div class="flex space-x-2 text-sm font-medium justify-start mt-3">
                      <button onClick={bookProduct} class="transition ease-in duration-300 inline-flex items-center text-sm font-medium mb-2 md:mb-0 bg-gradient-to-r from-slate-900 to-slate-700 px-5 py-2 hover:shadow-lg tracking-wider text-white rounded-lg hover:bg-gray-900 ">
                        <span>View</span>
                      </button>
                    </div>
                  </div>
